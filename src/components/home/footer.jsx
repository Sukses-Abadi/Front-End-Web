    ...
    <div className="sticky bottom-0">
      ...
      <footer className="mt-auto footer p-10 bg-primary text-base-content">
        ...
        <nav>
          ...
          <a className="link link-hover text-white font-light">
            Jam dan Hari Kerja
          </a>
          <a className="link link-hover text-white font-light">09.00 - 17.00</a>
          <a className="link link-hover text-white font-light">
            (Senin - Minggu)
          </a>
        </nav>
      ...
      <footer className="footer footer-center pb-4 bg-primary text-base-content">
        <aside>
          <p className="text-white text-md">
            Copyright © 2023 - Sukses Abadi | Developed by Kelompok 1
          </p>
        </aside>
      </footer>
    </div>
